...
it('can sign and verify with JWS', async () => {
  ...
  expect(compactJws).toBe(
    'eyJhbGciOiJFUzI1NksifQ.eyJoZWxsbyI6IndvcmxkIn0.Scf569hgWxDqpJG_0XmHsF-Dt_SZET0kz4z3OHf44g4Pyi1q8QP0KdVfInWBJ-9efQRihnEJZ50RaLzztlCbrQ'
  );
